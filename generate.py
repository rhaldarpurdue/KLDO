...
import warnings
from eval_utils import patch_open, logging_cuda_memory_usage
from eval_utils import DEFAULT_SYSTEM_PROMPT, SHORT_SYSTEM_PROMPT, MISTRAL_SYSTEM_PROMPT
import gc
import random
...
def main(args):
    ...
    state_dict = torch.load(f"{args.pretrained_model_path}/FINAL/merged.pt")
